...
<form id="post" name="post" action="fabiao1.php" method="post">
...
<tr>
      ...
      <td >
        <input type="text" id="ti" name="biaoti" style="width:425px;" value=" "  >
...
<div ><label for="textfield">验证码</label>
	...
	</div><div style="padding-left:95px;" ></div>
</td>
</tr>
<tr>
<td valign="top" >&nbsp;</td>
<td>
<input type="submit" id="Submit3" name="submit_fabiao1" value="发表贴子">&nbsp;&nbsp; <a name="sub"></a></td>
<td>&nbsp;</td>
</tr>
<tr align="left">
